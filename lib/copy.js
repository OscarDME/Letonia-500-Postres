// VIENĪGAIS REDZAMĀ SATURA AVOTS — viss mērķlapas teksts atrodas šeit.
// Komponentēs nedrīkst būt hardkodētas virknes.
export const copy = {
  metadata: {
    title: "500 Veselīgas kūkas — Vecmāmiņa Rasma",
    description:
      "500 receptes mīkstām, gaisīgām un gardām kūkām, pilnībā bez lipekļa (glutēna), piena produktiem un cukura.",
    productName: "Grāmata „Vecmāmiņas Rasmas 500 kūkas”",
  },

  hero: {
    urgencyBar: "PIEDĀVĀJUMS BEIDZAS ŠODIEN · 90% ATLAIDE tikai šodien",
    badge: "Jauna recepšu grāmata · +3 200 apmierinātu klientu",
    headline: {
      before: "TU NEKAD VAIRS NESKATĪSIES UZ ",
      accent: "VESELĪGĀM KŪKĀM",
      after: " TĀPAT, KAD BŪSI REDZĒJIS ŠO.",
    },
    subheadline:
      "Atklāj 500 receptes mīkstām, gaisīgām un gardām kūkām, pilnībā bez lipekļa, piena produktiem un cukura. Izbaudi katru kumosu bez vainas apziņas vai ierobežojumiem.",
    ctaLabel: "JĀ, ES VĒLOS RECEPTES",
    starsAriaLabel: "Vērtējums 5 no 5 zvaigznēm",
    starsRating: "5.0",
    socialProof: "+3 200 sertificētu kursantu",
    trustChips: [
      { icon: "🌾", text: "Bez lipekļa" },
      { icon: "🥛", text: "Bez piena produktiem" },
    ...
    floatingBadges: {
      speed: { icon: "⏱️", top: "Gatavs vien", bottom: "20 minūtēs" },
  ...
  benefits: {
    ...
    items: [
      ...
      { icon: "📖", title: "Vienkāršas pamācības soli pa solim" },
    ],
  },

  samples: {
    kicker: "Izmēģini tās vispirms",
    headline: "NETICAMI GARDAS KŪKAS (VESELĪGĀ VERSIJA):",
    ...
    items: [
      ...
      {
        name: "BURKĀNU KŪKA",
        variant: "(AR FIT ŠOKOLĀDES GLAZŪRU)",
        kcal: "120",
        time: "20 min",
      ...
      },
      {
        ...
        alt: "Fitnesa sarkanā samta kūka",
      },
    ],
  ...
  moreRecipesCta: {
    ...
    big: "493",
    post: "KŪKU RECEPTES...",
    ctaLabel: "IEGŪT SAVU KOPIJU TŪLĪT",
  },

  testimonials: {
    kicker: "Reāli pierādījumi",
    headline: "LŪK, KO SAKA TIE, KURI TO JAU PEK AR MUMS",
    subheadline: "Ko stāsta mūsu lasītāji",
    studentsBadge: "+ 3 200 sertificētu kursantu",
    items: [
      {
  ...
  categories: {
    ...
    groups: [
      ...
      {
        title: "100 modernas kūkas",
        items: [
          { src: "/preview/1-7.webp", alt: "Moderna kūka 1" },
          { src: "/preview/2-6.webp", alt: "Moderna kūka 2" },
          { src: "/preview/3-5-1.webp", alt: "Moderna kūka 3" },
          { src: "/preview/4-3.webp", alt: "Moderna kūka 4" },
        ],
      },
      {
  ...
  finalCta: {
    ...
    headline: "VECMĀMIŅAS RASMAS 500 KŪKU GRĀMATA ®",
  ...
  delivery: {
    ...
    items: [
      ...
      { icon: "♾️", text: "Mūža piekļuve: tostarp visām jaunajām receptēm." },
  ...
  guarantee: {
    kicker: "Bez riska",
    headline: "IZMĒĢINI BEZ RISKA — 14 dienu beznosacījumu garantija.",
    body: "Tev ir 14 dienas, lai tās izmēģinātu. Ja receptes tevi nepārliecinās, es atgriezīšu tavu naudu līdz pēdējam centam. Bez sarežģījumiem. Bez stresa.",
    alt: "Zīmogs 14 dienu beznosacījumu garantijai",
    image: { src: "/guarantee-badge.webp", alt: "14 dienu garantija" },
  },
